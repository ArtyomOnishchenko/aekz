...
/**
 * @file
 * Contains \Drupal\first_module\Form\CollectPhoneSettings.
 */
...
class CollectPhoneSettings extends ConfigFormBase {
    ...
    protected function getEditableConfigNames() {
        ...
        // first_module.collect_phone.settings.yml
        return [
            'first_module.collect_phone.settings',
        ];
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $config = $this->config('first_module.collect_phone.settings');
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $this->config('first_module.collect_phone.settings')
